...
const uint32_t may_war_set_dijkstra[NUM_TEB_DIJKSTRA][2]={
    ...
    {300,3},{300,2},{301,1},{301,56},{300,3}
#endif
#if (DOUFIF)              //con-byte-wise-WAR. Base on O-mem.
    {0,0},{606,1},{600,1},{602,6},{0,0}
#endif
};
const uint8_t teb_breaking_dijkstra[NUM_TEB_DIJKSTRA]={
